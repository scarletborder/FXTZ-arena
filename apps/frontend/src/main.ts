...
import { BattleStartScene, BootstrapScene, CodexScene, DebugBulletVolumeScene, HomeScene, LoadingScene, LocalLanScene, ManualScene, ResultScene, RoomListScene, RoomLobbyScene, SelectScene, SettingsScene, StoryLoadoutScene, StoryProgressScene, StoryResultScene, StoryStartLoadoutScene, UdpConnectScene, ReplayRecordScene, ReplayPlaybackScene, SpectatorLoadingScene } from "./menu";
