...
function serializeFighter(
  ...
  return {
    ...
    youmuBombDashDelayRemaining: fighter.youmuBombDashDelayRemaining,
    youmuBombDashStartX: fighter.youmuBombDashStartX,
    youmuBombDashStartY: fighter.youmuBombDashStartY,
    youmuBombDashAimX: fighter.youmuBombDashAimX,
    youmuBombDashAimY: fighter.youmuBombDashAimY,
...
function serializeProjectile(
  ...
  return {
    ...
    previousHeight: projectile.previousHeight,
    previousRenderHeight: projectile.previousRenderHeight,
    height: projectile.height,
    centerOffsetX: projectile.centerOffsetX,
    centerOffsetY: projectile.centerOffsetY,
    ...
    followAimOwner: projectile.followAimOwner,
    followWhileActiveCharacterId: projectile.followWhileActiveCharacterId,
    followOwner: projectile.followOwner,
    followOwnerDistance: projectile.followOwnerDistance,
    followOwnerAngle: projectile.followOwnerAngle,
    rollUntil: projectile.rollUntil,
    rollStartedAt: projectile.rollStartedAt,
    widthGrowthPerTick: projectile.widthGrowthPerTick,
    maxWidth: projectile.maxWidth,
    heightGrowthPerTick: projectile.heightGrowthPerTick,
    maxHeight: projectile.maxHeight,
    renderHeightGrowthPerTick: projectile.renderHeightGrowthPerTick,
    maxRenderHeight: projectile.maxRenderHeight,
