...
| 阶段 | 时长 | 行为 |
|------|------|------|
| **聪明 (Smart)** | 25 秒 (1500 ticks) | CPU 完美躲避所有弹幕 |
| **钝化 (Dulling)** | 15 秒 (900 ticks) | 逐渐变得无法躲避，每帧精度下降 |
| **愚钝 (Dumb)** | 持续到受击 | 几乎不躲避，随机移动 |
...
钝化阶段的 900 ticks 内，以下参数从"聪明值"线性变化到"愚钝值"：

| 参数 | 聪明值 | 愚钝值 |
|------|--------|--------|
| `dodgeAccuracy` | 1.0 | 0.1 |
