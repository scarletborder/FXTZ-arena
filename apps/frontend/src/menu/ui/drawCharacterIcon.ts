...
export function drawCharacterIcon(
  scene: Phaser.Scene,
  ...
  graphics
    .lineStyle(4 * scale, 0xf6f1e6, 1)
    .strokeCircle(x, y + 6 * scale, 8 * scale);
  graphics
    .lineStyle(3 * scale, 0x101820, 0.9)
    .lineBetween(
      x - 22 * scale,
      y + 12 * scale,
      x + 26 * scale,
